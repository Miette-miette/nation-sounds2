...
const PageArtist = () => {
    ...
    if (!artist) return <p>Chargement en cours !</p>
    ...
    return (
        <main>
            ...
            <section className="d-flex flex-column-reverse flex-md-row justify-content-center wrapper-beige artist-info">
                <div className="artist-button d-flex flex-column ">
                    ...
                    <a href={artist.spotify_link} className="button-style mt-4">
                        <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" stroke="#ffffff" className="icon">
                            ...
                            <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-140.000000, -7479.000000)" fill="#fff"> 
                        ...
                        Ecoutez {artist.name} sur Spotify
                    </a>
                </div> 
